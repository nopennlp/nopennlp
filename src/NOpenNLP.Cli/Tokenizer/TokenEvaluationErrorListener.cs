...
/// to an output stream.
/// </summary>
public class TokenEvaluationErrorListener : EvaluationErrorPrinter<TokenSample>,
    ITokenizerEvaluationMonitor
{
    /// <summary>
    ...
    /// </summary>
    public TokenEvaluationErrorListener(TextWriter outputStream)
        : base(outputStream)
    {
    }
    ...
    /// </summary>
    public TokenEvaluationErrorListener(Stream outputStream)
