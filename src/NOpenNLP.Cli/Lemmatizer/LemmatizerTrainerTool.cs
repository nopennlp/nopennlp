...
public class LemmatizerTrainerTool : AbstractTrainerTool<LemmaSample?>
{
    ...
    /// <inheritdoc/>
    public override string Name => "LemmatizerTrainerME";

    /// <inheritdoc/>
    public override string ShortDescription => "trainer for the learnable lemmatizer";
    ...
    protected override void Run(ParseResult parseResult)
    {
        ...
        CmdLineUtil.WriteModel("lemmatizer", modelOutFile, lemmatizerModel);
    }
}
