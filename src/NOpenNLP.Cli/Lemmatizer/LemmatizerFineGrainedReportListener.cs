...
/// provided getters.
/// </summary>
public class LemmatizerFineGrainedReportListener : FineGrainedReportListener,
    ILemmatizerEvaluationMonitor
{
    ...
    /// </summary>
    public LemmatizerFineGrainedReportListener(TextWriter outputStream)
        : base(outputStream)
    {
    }
    ...
    /// </summary>
    public LemmatizerFineGrainedReportListener(Stream outputStream)
        : base(outputStream)
    {
    }
