...
/// <summary>
/// Test for the <see cref="PreviousMapFeatureGenerator"/> class.
/// </summary>
public class PreviousMapFeatureGeneratorTest
{
    ...
    {
        IAdaptiveFeatureGenerator fg = new PreviousMapFeatureGenerator();
        ...
        ClassicAssert.AreEqual("pd=null", features[0]);
        ...
        fg.CreateFeatures(features, sentence, 0, null);
        ClassicAssert.AreEqual(1, features.Count);
        ClassicAssert.AreEqual("pd=1", features[0]);
