...
{
    private static Dictionary GetDict() => new(true);
    ...
    public void TestLookup()
    {
        ...
        ClassicAssert.IsFalse(set.Contains(a.ToUpperInvariant()));
    }
    ...
    public void TestEqualsDifferentCase()
    {
        ...
        ClassicAssert.IsFalse(setA.Equals(setB));
    }
    ...
    public void TestDifferentCaseLookup()
    {
        ...
        ClassicAssert.IsFalse(set.Contains(entry2));
    }
    ...
    public void TestIterator()
    {
        ...
        ClassicAssert.AreEqual(4, elements.Count);
        ClassicAssert.IsTrue(elements.Contains(entry1));
        ClassicAssert.IsTrue(elements.Contains(entry2));
        ClassicAssert.IsTrue(elements.Contains(entry1.ToUpperInvariant()));
        ClassicAssert.IsTrue(elements.Contains(entry2.ToUpperInvariant()));
    }
}
