...
public class DictionaryLemmatizerTest
{
    ...
    public void LoadDictionary()
    {
        dictionaryLemmatizer = new DictionaryLemmatizer(
            TestResources.OpenResource("/opennlp/tools/lemmatizer/smalldictionary.dict")
        );
    }
    ...
    {
        string[] sentence = ["The", "dogs", "were", "running", "and", "barking", "down", "the", "street"];
        string[] sentencePOS = ["DT", "NNS", "VBD", "VBG", "CC", "VBG", "RP", "DT", "NN"];
        string[] expectedLemma = ["the", "dog", "is", "run", "and", "bark", "down", "the", "street"];
        ...
        for (int i = 0; i < sentence.Length; i++)
        {
            ...
            {
                ClassicAssert.AreEqual(expectedLemma[i], actualLemma[i]);
            }
        }
    }
}
