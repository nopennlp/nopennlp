...
internal class IrishSentenceBankTokenSampleStream : ObjectStreamBase<TokenSample?>
{
    ...
    internal IrishSentenceBankTokenSampleStream(IrishSentenceBankDocument source)
    {
        this.source = source;
