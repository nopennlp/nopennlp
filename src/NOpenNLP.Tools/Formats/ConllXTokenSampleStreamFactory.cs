...
{
    // NOpenNLP: see ConllXSentenceSampleStreamFactory for why the POS factory is held
    // directly rather than looked up in the registry and fed a filtered argument array.
    ...
    {
        IObjectStream<POSSample?> samples = PosSampleStreamFactory.Create(values);
