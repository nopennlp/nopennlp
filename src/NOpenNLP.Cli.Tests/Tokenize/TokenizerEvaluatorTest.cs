...
/// <remarks>
/// NOpenNLP: upstream keeps this test in opennlp-tools, beside the tokenizer it
...
public class TokenizerEvaluatorTest
{
    ...
    public void TestPositive()
    {
        ...
        ITokenizerEvaluationMonitor listener = new TokenEvaluationErrorListener(stream);
        ...
        TokenizerEvaluator eval = new(new DummyTokenizer(
    ...
    public void TestNegative()
    {
        ...
        eval.EvaluateSample(TokenSampleFixtures.CreatePredSample());

        ClassicAssert.AreEqual(.5d, eval.FMeasure.Value, .1d);
    ...
    /// </summary>
    private sealed class DummyTokenizer(TokenSample sample) : ITokenizer
    {
        private readonly TokenSample sample = sample; // NOpenNLP: made readonly

        public string[] Tokenize(string s) => null!;

        public Span[] TokenizePos(string s) => sample.TokenSpans;
    }
}
